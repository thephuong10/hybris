...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/hcmuestorefront/electronics/en",
						"https://electronics.local:9002/hcmuestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/hcmuestorefront/electronics/en",
						"https://electronics.local:9002/hcmuestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/hcmuestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/hcmuestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/hcmuestorefront/electronics/en",
						"https://electronics.local:9002/hcmuestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/hcmuestorefront",
						"https://electronics.local:9002/hcmuestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/hcmuestorefront",
						"https://electronics.local:9002/hcmuestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/hcmuestorefront/electronics/en",
						"https://electronics.local:9002/hcmuestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
