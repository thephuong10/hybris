 ...
 */
package hcmue.edu.vn.core.constants;

/**
 * Global class for all HcmueCore constants. You can add global constants for your extension into this class.
 */
public final class HcmueCoreConstants extends GeneratedHcmueCoreConstants
{
	public static final String EXTENSIONNAME = "hcmuecore";


	private HcmueCoreConstants()
	{
		//empty
	}
